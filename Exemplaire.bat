...
svcutil D:\BibliothequeExamen\Bibliotheque\COUCHEIFAC.ClsIFACExemp.wsdl D:\BibliothequeExamen\Bibliotheque\*xsd /out:D:\BibliothequeExamen\Bibliotheque\Bibliotheque\Proxies\ClsIFACExemp.cs /async /ct:System.Collections.Generic.List`1 /r:D:\BibliothequeExamen\Bibliotheque\COUCHEIFAC\bin\Debug\COUCHEBO.dll /n:*,Bibliotheque.Proxies /noConfig
