...
svcutil D:\BibliothequeExamen\Bibliotheque\COUCHEIFAC.ClsIFACLecteur.wsdl D:\BibliothequeExamen\Bibliotheque\*xsd /out:D:\BibliothequeExamen\Bibliotheque\Bibliotheque\Proxies\ClsIFACLecteur.cs /async /ct:System.Collections.Generic.List`1 /r:D:\BibliothequeExamen\Bibliotheque\COUCHEIFAC\bin\Debug\COUCHEBO.dll /n:*,Bibliotheque.Proxies /noConfig
